 ...
 */
class NewRecipesAdapter(private val context: Context, private val modelRecipes: List<ModelRecipes>) :
        RecyclerView.Adapter<NewRecipesAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.list_new_recipe, parent, false)
